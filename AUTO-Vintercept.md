# VINtercept(AUTOMOTIVE):
    ...
    5.I navigated between panes using ctrl+b then arrow keys."can send vcan0 733#0322F1900000", crafted this UDS request to get the vin using service 0*22 standard for VIN,
here 733 = ECU request id.  
